# 🩺 Mana — مانا
### Your Trusted Health Companion · همراه هوشمند سلامت

> 💬 *When patients Google their symptoms or ask ChatGPT about their medications, they get answers — but not always the right ones.*
> 
> *Mana gives them the right ones.* ✨
...
**Mana is different.** It answers health questions directly from verified clinical guidelines — the same standards doctors actually rely on. Ask about your blood sugar target 🩸, your blood pressure medication 💊, or what a lab result means 🔬. Mana finds the answer in the actual guideline and gives it to you clearly, in your language.

> 🛡️ **If the answer isn't in the guidelines, Mana says so.**
...
### 👉 [**Try Mana Now → huggingface.co/spaces/NafisehS/Mana**](https://huggingface.co/spaces/NafisehS/Mana)
...
├── ⚙️ ingest.py              # PDF processor & database builder
├── 📋 requirements.txt
...
2. ▶️ Run `python ingest.py`

The pipeline automatically:
- 🧹 Filters out reference lists and blank pages
- ✂️ Chunks text intelligently with overlap
- 🏷️ Tags each chunk with its source document
...
- 🛡️ **Honesty over helpfulness** — Mana will not answer outside its knowledge base. Ever.
